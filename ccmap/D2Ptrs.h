...
FUNCPTR(D2CLIENT, AddUnit, VOID __stdcall,(DWORD dwUnitId, DWORD _1, DWORD dwType, DWORD _2, CHAR* szName), 0x20D60)
FUNCPTR(D2CLIENT, UpdateClientPos, VOID __fastcall, (BYTE* pPacket, DWORD dwSize), 0x67BB0)
FUNCPTR(D2CLIENT, AssignPlayerUnit, VOID __fastcall, (BYTE* pPacket, DWORD dwSize), 0x65C40)
FUNCPTR(D2CLIENT, InitGameMisc_I, VOID __stdcall, (DWORD Dummy1, DWORD Dummy2, DWORD Dummy3), 0x7CD2B)
//6FB17BB0   . 53             PUSH EBX                                 ;  kernel32.7C802415
...
ASMPTR(D2CLIENT, TestPvpFlag_I, 0x30D20) // Updated
...
FUNCPTR(D2COMMON, AddRoom, Room1* __stdcall, (WORD wX, WORD wY), 0x6FEF0)
//6FDA6938  |. E8 B3950100    CALL D2Common.6FDBFEF0
//6FB2CBB0
...
FUNCPTR(FOG, 10101, DWORD __fastcall, (DWORD _1, DWORD _2 /* Both Parameters seem to be always Zero..?*/), -10101)
FUNCPTR(FOG, 10089, DWORD __fastcall, (DWORD _1 /* Seems to be 1 (TRUE) */), -10089)
FUNCPTR(FOG, 10218, DWORD __fastcall, (VOID), -10218) // Inits the Game Server
FUNCPTR(D2WIN, 10059, DWORD __fastcall, (VOID), -10059) // Inits the MPQ files
FUNCPTR(D2WIN, 10073, DWORD __fastcall, (DWORD _1, DWORD _2, DWORD _3, d2client_struct* pD2Client), -10073)
FUNCPTR(D2WIN, 10188, DWORD __stdcall, (HANDLE hModule, DWORD _1, DWORD _2, DWORD _3), -10188)
FUNCPTR(D2WIN, 10109, DWORD __stdcall, (DWORD _1, DWORD _2), -10109)
FUNCPTR(D2SOUND, 10032, DWORD __fastcall, (DWORD _1), -10032)

FUNCPTR(D2COMMON, InitDataTables, DWORD __stdcall, (DWORD _1, DWORD _2, DWORD _3), -10797)
//10944
FUNCPTR(D2LANG, InitStringTable, VOID __fastcall, (DWORD dwUnk1, DWORD dwUnk2, CHAR* szBuffer, DWORD dwUnk3), -10004)
FUNCPTR(D2LANG, 10003, DWORD __fastcall, (DWORD _1, CHAR* _2, DWORD _3), -10003)
